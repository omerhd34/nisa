    ...
    >
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="grid md:grid-cols-5 gap-8 md:gap-12 items-center">
              <div className="md:col-span-2">
                <div
                  className={`relative w-64 h-64 md:w-80 md:h-80 mx-auto bg-gradient-to-br ${
                    isDark
                ...
                <div
                  ...
                  className={`${
                    isDark
                      ...
                      : "bg-white/90"
                  } rounded-2xl shadow-xl p-8 text-center transform hover:scale-105 hover:-translate-y-2 transition-all duration-500 animate-slideUp animation-delay-${
                    200 + index * 100
                  }`}
                >
                  <div
          ...
          {/* Quote Section */}
          <div
            className={`mt-12 text-center p-8 md:p-12 rounded-3xl ${
              isDark
          ...
          >
            ...
            >
              ...
              <span
                className={`block mt-3 font-extrabold italic ${
                  isDark ? "text-teal-300" : "text-teal-800"
                }`}
              >
                Jacques Lacan

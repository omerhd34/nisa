    ...
    <div className="max-w-4xl mx-auto">
     ...
     {article.writer && (
      <div className="flex items-center mb-10">
       <span
        className={`font-medium italic -mt-2 ${isDark ? "text-gray-200" : "text-gray-800"}`}
       >
        {article.writer}
       </span>
      </div>
     ...
     {article.poem && (
      ...
      >
       <p
        className={`text-lg leading-relaxed whitespace-pre-line italic text-center ${isDark ? "text-gray-300" : "text-gray-700"
         }`}
       >
        {article.poem}
       </p>
       <p
        className={`text-lg mt-4 font-bold leading-relaxed whitespace-pre-line italic text-center ${isDark ? "text-gray-300" : "text-gray-700"
         }`}
       >{article.writer2}</p>
      </div>
     )}
     ...
     >
      <p
       className={`text-lg leading-relaxed whitespace-pre-line ${isDark ? "text-gray-300" : "text-gray-700"
        }`}
      >
       {article.content}
      </p>
     ...
     {(article.source) && (
      ...
      >
       {article.source && (
        <div
         className={`text-sm leading-relaxed whitespace-pre-line italic ${isDark ? "text-gray-400" : "text-gray-600"
          }`}
        >

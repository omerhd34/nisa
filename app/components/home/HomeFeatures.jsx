'use client';
import { Users, Video, Brain, Heart, Sparkles } from 'lucide-react';
       ...
       return (
        <div
         ...
         className={`group ${isDark
          ...
          } rounded-3xl shadow-2xl p-8 md:p-10 hover:shadow-3xl hover:shadow-emerald-500/20 transform hover:scale-105 hover:-translate-y-3 transition-all duration-500 animate-slideUp`}
         style={{ animationDelay: `${600 + index * 100}ms` }}
        >
         <div
          className={`bg-linear-to-br ${isDark

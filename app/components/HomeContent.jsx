    ...
    <div className="container mx-auto px-4">
     <div className="max-w-6xl mx-auto">
      <div className="text-center mb-16">
       ...
       >
        Profesyonel yaklaşım ve kişiye özel çözümlerle yanınızdayım.
       </p>
      </div>
      ...
      >
       ...
       <div className="relative z-10">
        ...
        <p className="text-lg md:text-xl mb-8 opacity-90 max-w-2xl mx-auto">
         Bugün kendinize yatırım yapın. Daha mutlu ve sağlıklı bir
         yaşam için birlikte çalışalım.
        </p>
        <button className="bg-white text-teal-700 px-10 py-4 rounded-xl font-bold text-lg hover:scale-105 hover:shadow-2xl transform transition-all duration-300">
         <Link href="/contact">

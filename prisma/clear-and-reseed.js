  ...
  try {
    ...
    const articles = [
      ...
      },
      {
        ...
        Gerçek bir baba, fiziksel ve duygusal olarak var olmasa da her zaman içsel bir tasarım olarak
        vardır ve varlığı, iç dünyada bir nesne olarak süreklidir. Winnicott’ın (1957) ifadesiyle baba, bir
        “yapı”dır, koruyucu ve kollayıcıdır. Varlığını hissetmediğimizde tekinsizlik ve güvensizlik hissi
        belirir. Annenin ruhsal olarak yokluğunda yaşadığımız güvensizlik, babanın ruhsal olarak
        yokluğunda da kendini gösterir.\n\n
        Freud, erken dönemde babanın sevgi ve koruma deneyiminin içselleştirildiğini ve yaşam boyu
        karşılaşılan tehlike ve korkularla dolu bu sürece dayanma gücünü sağladığı ifade eder. Anne,
        bedensel bütünlüğün oluşumunda ne kadar önemliyse, aynı dönemde oluşan baba imgesi de dış
        dünyanın tehlikelerine karşı varoluşsal bütünlüğün sürdürülmesinde o kadar önemlidir. Anne ve
        baba işlevi tıpkı bir Yin-Yang gibi birbirini tamamlar, yeri ve zamanı geldiğinde anne, baba işlevi
        görebilir; baba annesel bir işlevi yerine getiriyor olabilir.\n\n
        Freud, pre-ödipal baba figürünü aşk ve erken özdeşim nesnesi, benlik ideali, bilgi kaynağı, güven
        veren ama aynı zamanda kıskanılan bir varlık ve hatta tanrısal bir güç olarak tanımlar. Baba,
        çocuk tarafından hem rakip olarak görülüp nefret edilen biri, hem de sevilen, özlenen, oyun
        arkadaşı ve bakıcı olarak algılanır. Bu yönü ile baba işlevi yalnızca ödipal üçgende kısıtlayan,
        cezalandıran, süperegonun temelini oluşturan bir aktör değil; aynı zamanda babaya duyulan
        sevdanın özümsenmesi, özdeşleşmesi üzerinden kız çocuk için ödipal aşktaki aktör, erkek çocuk
        için ise psikoseksüel olarak sonraki adıma geçirebilen, bu anlamda hayata hazırlayandır.`,
      ...
      },
      {
        ...
        slug: "hic-dilinizin-surctugu-bir-anı-dusundunuz-mu",
        image: "/dil.jpg",
        readTime: "4 dk",
        excerpt:
